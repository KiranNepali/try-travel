...
function Footer({}: Props) {
  return (
    <>
      <div className="w-full pt-[5rem] relative flex items-center justify-center bg-black">
        <div className="mask1 absolute top-0 left-0 w-full h-[30%] bg-gradient-to-b from-black  to-transparent z-10"></div>
        <div className="absolute top-0 left-0 bg-black w-full h-full opacity-[0.7] z-10"></div>
        ...
        <div className="w-11/12 z-20  px-4 text-white flex flex-col">
          <div className="w-full text-7xl">
            <h1 className="w-full md:w-2/3 font">
              How can we help you. get in touch
            </h1>
          </div>
          <div className="flex mt-8 flex-col md:flex-row md:justify-between">
            <p className="w-full md:w-2/3 text-zinc-200">
          ...
          <div className="flex flex-col">
            <div className="flex mt-24 mb-5 flex-row justify-between">
              {/* logo  */}
              ...
              {/* links  */}
              <div className="flex  w-9/12 justify-around text-sm font-semibold">
                <a className="hidden md:block cursor-pointer text-zinc-200 hover:text-white uppercase">
                  About
                </a>
                <a className="hidden md:block cursor-pointer text-zinc-200 hover:text-white uppercase">
                  Services
            ...
            <p className="w-full text-center my-5 text-[13px] text-zinc-300">
              Copyright © 2024 WebX
            </p>
          </div>
        </div>
